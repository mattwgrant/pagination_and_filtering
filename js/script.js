...
/*** 
   ...
   Second, I create pageItems which is simply the number of items that I want to display on each page.
***/
...
function showPage(list, page) {
  ...
  ***/
  ...
  /***
    I use a for loop to run through the length of the student list. Inside of the loop, I use a conditional
...
/***
  This is the start of my search functionality. I am not submitting it to be graded but am keeping it
  because I plan on completing this at a later date
 ***/
...
function appendPageLinks(list) {
  /***
    I am creating the elements necessary for the pagination links and appending them to their
